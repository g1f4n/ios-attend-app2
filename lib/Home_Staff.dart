...
class HomeStaff extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => HomeStaffState();
}

class HomeStaffState extends State<HomeStaff> {
  ...
  DateTime pointTime, timeHasAttend, timeFinishAttend, timeIzin, timeCuti;
  ...
  void initState() {
    ...
    pr.style(message: "CEK VALIDASI ABSEN...");
    getDataProfile();
  }
  ...
  getDataProfile() async {
    ...
    setState(() {
      ...
      if (timeAttendFinish != null) {
        timeFinishAttend = DateTime.parse(timeAttendFinish).toLocal();

        checkDate = checkFormat.format(pointTime);
        hasAttendFinishDate = timeFormat.format(timeFinishAttend);
      }
