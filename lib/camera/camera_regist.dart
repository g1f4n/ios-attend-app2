...
class CameraRegist extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CameraRegistState();
}

class CameraRegistState extends State<CameraRegist> {
  ProgressDialog pr;
  ...
  Widget build(BuildContext context) {
    setState(() {
      pr = new ProgressDialog(context,
          ...
          isDismissible: false,
          showLogs: false);
      pr.style(message: "Verifikasi Foto...");
    });
    return Container(
      decoration:
  ...
  void _onCapturePressed(context) async {
    ...
    String filename = "Regist_" + ddmmyy + time + ".jpg";
    ...
    try {
      ...
      cameraController.takePicture(path).then((value) {
        var response;
        ApiService().validFaceCheck(path, filename).then((value) {
          ...
          if (response['status'] == 1) {
            ...
            Alert(
              ...
              desc: "Verifikasi berhasil, wajah terdeteksi.",
              buttons: [
                DialogButton(
                  child: Text(
                    "OK",
            ...
            Alert(
              ...
              desc:
                  "Verifikasi GAGAL, wajah tidak terdeteksi.\nMohon ambil foto ulang",
              buttons: [
                DialogButton(
                  child: Text(
                    "OK",
            ...
            Alert(
              ...
              title: "VERIFIKASI GAGAL",
              desc:
                  "Verifikasi GAGAL, terjadi kesalahan pada sistem.\nMohon ambil foto ulang",
              buttons: [
                DialogButton(
                  child: Text(
                    "OK",
